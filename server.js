...
let priceRules = [
  ...
  // 25% de marge
  { name: 'Au Saucisson Vaudois', type: 'percent', value: -25 },
  { name: 'Beau Soir - Dépanneur Grimard Mercier', type: 'percent', value: -25 },
  { name: 'Dépanneur Conrad-Gosselin Inc.', type: 'percent', value: -25 },
  { name: 'Dépanneur Croisetière Inc.', type: 'percent', value: -25 },
  { name: 'Dépanneur des Vergers', type: 'percent', value: -25 },
  ...
  { name: 'Dépanneur Noémy', type: 'percent', value: -25 },
  { name: 'Dépanneur Noémy 2 inc', type: 'percent', value: -25 },
  { name: 'Dépanneur Saint-Blaise', type: 'percent', value: -25 },
  { name: 'Depanneur Plus', type: 'percent', value: -25 },
  { name: 'ESSO STATION services domax inc.', type: 'percent', value: -25 },
  { name: 'Fraichement Bon Jarry', type: 'percent', value: -25 },
  ...
  { name: 'IGA Candiac Sobeys Capital Inc', type: 'percent', value: -25 },
  { name: 'IGA Extra Place Longueuil', type: 'percent', value: -25 },
  ...
  { name: 'IGA extra Famille Vincent', type: 'percent', value: -25 },
  { name: 'IGA extra Les Marchés Lambert Carignan', type: 'percent', value: -25 },
  ...
  { name: 'IGA extra Les Marchés Pepin inc.', type: 'percent', value: -25 },
  ...
  { name: 'IGA Marché Ile des Soeurs #8213', type: 'percent', value: -25 },
  { name: 'IGA Marché Lambert St-Bruno (8341)', type: 'percent', value: -25 },
  { name: 'IGA Pepin Mont-Saint-Hilaire', type: 'percent', value: -25 },
  { name: 'IGA Raymond', type: 'percent', value: -25 },
  ...
  { name: 'Marché Toit Rouge Repentigny', type: 'percent', value: -25 },
  { name: 'Marché Tradition Sainte-Mélanie', type: 'percent', value: -25 },
  { name: 'Marché Tradition Ste-Madeleine', type: 'percent', value: -25 },
  { name: 'Marché Venise', type: 'percent', value: -25 },
  { name: 'Mayrand Limitée - Anjou', type: 'percent', value: -25 },
  { name: 'Mayrand Limitée - Laval', type: 'percent', value: -25 },
  { name: 'Mayrand Limité - Brossard', type: 'percent', value: -25 },
  { name: 'Mayrand Limitée - St-Jérôme', type: 'percent', value: -25 },
